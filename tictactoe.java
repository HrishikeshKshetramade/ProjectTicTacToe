...
public class TicTacToe {
	...
	if(b1==1&&b2==1&&b3==1)
	{
		JOptionPane.showMessageDialog(frmTictactoe, "Congratulations X wins... :)","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
		cntofx1++;
	...
	{
		JOptionPane.showMessageDialog(frmTictactoe, "Congratulations O wins... :)","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
		cntofo1++;
	...
	private void initialize() {
		...
		frmTictactoe.setFont(new Font("sans serif", Font.BOLD, 18));
		...
		btn1.setFont(new Font("sans serif", Font.BOLD, 60));
		...
		btn2.setFont(new Font("sans serif", Font.BOLD, 60));
		...
		btn3.setFont(new Font("sans serif", Font.BOLD, 60));
		...
		lblNewLabel.setFont(new Font("sans serif", Font.BOLD, 25));
		...
		cntofx.setFont(new Font("sans serif", Font.BOLD, 30));
		cntofx.setText("0");
		...
		btn4.setFont(new Font("sans serif", Font.BOLD, 60));
		...
		btn5.setFont(new Font("sans serif", Font.BOLD, 60));
		...
		btn6.setFont(new Font("sans serif", Font.BOLD, 60));
		...
		lblNewLabel_1.setFont(new Font("sans serif", Font.BOLD, 25));
		...
		cntofo.setFont(new Font("sans serif", Font.BOLD, 30));
		cntofo.setText("0");
		...
		btn7.setFont(new Font("sans serif", Font.BOLD, 60));
		...
		btn8.setFont(new Font("sans serif", Font.BOLD, 60));
		...
		btn9.setFont(new Font("sans serif", Font.BOLD, 60));
		...
		resetbtn.setFont(new Font("sans serif", Font.BOLD, 23));
		...
		exitbtn.setFont(new Font("sans serif", Font.BOLD, 23));
